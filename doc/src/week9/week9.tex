...
\begin{frame}[plain,fragile]
\frametitle{Overview of week March 16-20, 2025}
...
\begin{frame}[plain,fragile]
\frametitle{Central limit theorem, reminder from last week}
...
\begin{frame}[plain,fragile]
\frametitle{Statistics, more technicalities}
...
\begin{frame}[plain,fragile]
\frametitle{Statistics and sample variance}
...
\begin{frame}[plain,fragile]
\frametitle{Statistics, uncorrelated results}
...
\begin{frame}[plain,fragile]
\frametitle{Statistics, computations}
...
\begin{frame}[plain,fragile]
\frametitle{Statistics, more on computations of errors}
...
\begin{frame}[plain,fragile]
\frametitle{Statistics, wrapping up 1}
...
\begin{frame}[plain,fragile]
\frametitle{Statistics, final expression}
...
\begin{frame}[plain,fragile]
\frametitle{Statistics, effective number of correlations}
...
\begin{frame}[plain,fragile]
\frametitle{Computing the correlation function}
