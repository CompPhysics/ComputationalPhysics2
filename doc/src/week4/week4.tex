...
%% doconce format latex week4.do.txt --minted_latex_style=trac --latex_admon=paragraph --no_mako
%%
...
% !split
\subsection*{Overview of week 6, February 6-10}


% --- begin paragraph admon ---
\paragraph{Topics.}
\begin{itemize}
\item Importance Sampling, practical aspects, discussion of code and computational issues

\item Fokker-Planck and Langevin equations
...
% !split
\subsection*{Importance sampling, what we are planning this week}
...
\begin{enumerate}
\item First we want to give you an overarching  view on the equations we need to program in order to perform importance sampling with a simple Python code that demonstrates the essential elements.

\item Secondly, we will go through the computational elements we need in order to program the local energy, the trial wave functions and the so-called \textbf{quantum force} in the most efficient way (computationally).

\item Finally, we will try to give a better connection between the equations for importance sampling and their links with the Fokker-Planck and Langevin equations. 
\end{enumerate}
...
% !split
\subsection*{Teaching Material, videos and textbooks}


% --- begin paragraph admon ---
\paragraph{}
\begin{enumerate}
\item You may find the following \href{{https://www.youtube.com/watch?v=H9I0PmXwhdo}}{Lecture on the Langevin and Fokker-Planck equations} as a useful introduction. 

\item The textbook of \href{{https://www.springer.com/gp/book/9783540707127}}{Gardiner on Stochastic Methods} is a classic and chapters 4 and 5 are the most relevant ones in order to get a better understanding of these equations. The textbook can be downloaded via UiO's subscription to Springer. Alternatively, the \href{{https://github.com/CompPhysics/ComputationalPhysics2/blob/gh-pages/doc/Literature/StochasticMethods.pdf}}{link here} gives you an earlier version.

\item Another excellent reference on topics like Brownian motion, Markov chains, the Fokker-Planck equation and the Langevin equation is the text by  \href{{http://www.elsevier.com/books/stochastic-processes-in-physics-and-chemistry/van-kampen/978-0-444-52965-7}}{Van Kampen}
\end{enumerate}
...
% !split
\subsection*{Overview of what needs to be coded}
...
% !split
\subsection*{Importance sampling, program elements in C++}
...
% !split
\subsection*{Use the \href{{http://www.cplusplus.com/reference/random/}}{C++ random class for random number generations}}
...
% !split
\subsection*{Use the C++ random class for RNGs, the Mersenne twister class}

% --- begin paragraph admon ---
\paragraph{}
\textbf{Finding the new position for importance sampling}
...
% !split
\subsection*{Use the C++ random class for RNGs, the Metropolis test}

% --- begin paragraph admon ---
\paragraph{}
\textbf{Using the uniform distribution for the Metropolis test}
