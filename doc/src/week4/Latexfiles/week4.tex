...
\title{Importance Sampling and Metropolis-Hastings' algorithm}
...
\begin{frame}[plain,fragile]
\frametitle{Overview of week February 9-13, 2026}

\begin{block}{Topics }
\begin{itemize}
\item Short repetition from last week

\item Mathematical and computational details of importance sampling and Fokker-Planck and Langevin equations
\end{itemize}
...
% * Reading suggestions:
% * \href{{https://youtu.be/MjRXwW9CcO0}}{Video of lecture}
% * \href{{https://github.com/CompPhysics/ComputationalPhysics2/blob/gh-pages/doc/HandWrittenNotes/2025/NotesFebruary14.pdf}}{Whiteboard notes}
% \end{block}
\end{frame}
...
\begin{block}{}
To read more about Metropolis, Markov Chains, importance sampling,
Fokker-Planck and Langevin equations, we recommend Becca and Sorella's
text, sections 3.4-3.9 and 4.2-4.4.
\end{block}
\end{frame}

\begin{frame}[plain,fragile]
\frametitle{Importance sampling and  overview of what needs to be coded, reminder from last week}
...
\begin{frame}[plain,fragile]
\frametitle{Code example for the interacting case with importance sampling}
