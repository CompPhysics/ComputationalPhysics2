...
%% doconce format latex week7.do.txt --latex_title_layout=beamer --latex_table_format=footnotesize --no_mako
%%
...
% !split
\subsection{Overview of week March 2-6}
...
% !split
\subsection{Teaching Material, videos and written material}
\begin{block}{}
\begin{enumerate}
...
% !split
\subsection{Inverse of the Jacobian}
...
% !split
\subsection{Broyden’s Algorithm for Solving Nonlinear Equations}
...
% !split
\subsection{Just a short reminder of Newton’s Method}
...
\noindent
% !split
\subsection{Broyden’s Good Method}
...
% !split
\subsection{Broyden’s Bad Method}
...
% !split
\subsection{BFGS optimization problem}
...
\noindent
% !split
\subsection{Improving gradient descent with momentum}
...
% !split
\subsection{Same code but now with momentum gradient descent}
