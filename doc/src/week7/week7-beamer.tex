...
\logo{{\tiny \copyright\ 1999-2026, Morten Hjorth-Jensen  Email morten.hjorth-jensen@fys.uio.no. Released under CC Attribution-NonCommercial 4.0 license}}
...
\ \\ 
{\tiny \copyright\ 1999-2026, Morten Hjorth-Jensen  Email morten.hjorth-jensen@fys.uio.no. Released under CC Attribution-NonCommercial 4.0 license}
}
...
\begin{frame}[plain,fragile]
\frametitle{Overview of week March 2-6}

\begin{block}{Gradient methods: }
\begin{enumerate}
\item Semi-Newton methods (Broyden's algorithm, Broyden-Farberg-Goldberg-Shanno algorithm, and Powell's algorithm)

\item Steepest descent and conjugate gradient descent

\item Stochastic reconfiguration
\end{enumerate}
...
\begin{frame}[plain,fragile]
\frametitle{Teaching Material, videos and written material}

\begin{block}{}
\begin{enumerate}
\item These lecture notes
% o "Video of lecture at \href{{https://youtu.be/wO1stGJkDEg}}{\nolinkurl{https://youtu.be/wO1stGJkDEg}}
% o "Handwritten notes at \href{{https://github.com/CompPhysics/ComputationalPhysics2/blob/gh-pages/doc/HandWrittenNotes/2026/FYS4411week7.pdf}}{\nolinkurl{https://github.com/CompPhysics/ComputationalPhysics2/blob/gh-pages/doc/HandWrittenNotes/2026/FYS4411week7.pdf}}
...
\begin{frame}[plain,fragile]
\frametitle{Inverse of the Jacobian}
...
\begin{frame}[plain,fragile]
\frametitle{More on Steepest descent}
...
\begin{frame}[plain,fragile]
\frametitle{The sensitiveness of the gradient descent}
...
\begin{frame}[plain,fragile]
\frametitle{Conditions on convex functions}
...
\begin{frame}[plain,fragile]
\frametitle{More on convex functions}
...
\begin{block}{Any minimum is global for convex functions }
...
\begin{frame}[plain,fragile]
\frametitle{Some simple problems}
...
\begin{frame}[plain,fragile]
\frametitle{Broyden’s Algorithm for Solving Nonlinear Equations}
...
\begin{frame}[plain,fragile]
\frametitle{Just a short reminder of Newton’s Method}
...
\begin{frame}[plain,fragile]
\frametitle{Broyden’s Good Method}
...
\begin{frame}[plain,fragile]
\frametitle{Broyden’s Bad Method}
...
\begin{frame}[plain,fragile]
\frametitle{Broyden–Fletcher–Goldfarb–Shanno algorithm}
...
\begin{frame}[plain,fragile]
\frametitle{Standard steepest descent}
...
\begin{frame}[plain,fragile]
\frametitle{Using gradient descent methods, limitations}
...
\item \textbf{Gradients are computationally expensive to calculate for large datasets}. In many cases the energy function is a sum of terms, with one term for each data point. For example, in linear regression, $E \propto \sum_{i=1}^n (y_i - \mathbf{w}^T\cdot\mathbf{x}_i)^2$; for logistic regression, the square error is replaced by the cross entropy. To calculate the gradient we have to sum over \emph{all} $n$ data points. Doing this at every GD step becomes extremely computationally expensive. An ingenious solution to this, is to calculate the gradients using small subsets of the data called ``mini batches''. This has the added benefit of introducing stochasticity into our algorithm.
...
\begin{frame}[plain,fragile]
\frametitle{Improving gradient descent with momentum}
...
\begin{frame}[plain,fragile]
\frametitle{Same code but now with momentum gradient descent}
