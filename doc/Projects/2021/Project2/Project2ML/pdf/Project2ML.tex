...
{\LARGE\bf
\begin{spacing}{1.25}
Project 2, The restricted Boltzmannn machine applied to the quantum many body problem. Deadline June 1, Spring 2022
\end{spacing}
}
\end{center}
...
\paragraph{Project 2 f): Replacing a Boltzmann machine with a neural network.}
