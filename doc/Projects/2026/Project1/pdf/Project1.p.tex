...
{\LARGE\bf
\begin{spacing}{1.25}
Project 1, deadline  March 20, 2026
\end{spacing}
}
\end{center}
...
\paragraph{Project 1 f): Optional: Parallelizing your code.}
...
\textbf{This part is optional if you program in Python, it is less trivial, compared to programming languanges like C++/C and Fortan}.
