...
%% doconce format latex Project2CC.do.txt --print_latex_style=trac --latex_admon=paragraph
%%
...
{\LARGE\bf
\begin{spacing}{1.25}
FYS4411/9411 Project 2, Coupled cluster studies of electronic systems. Deadline June 1
\end{spacing}
}
\end{center}
