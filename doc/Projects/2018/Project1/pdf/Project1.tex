...
\fancypagestyle{plain}{
  \fancyhf{}
  \fancyfoot[C]{{\footnotesize \copyright\ 1999-2018, "Computational Physics I FYS4411/FYS9411":"http://www.uio.no/studier/emner/matnat/fys/FYS4411/index-eng.html". Released under CC Attribution-NonCommercial 4.0 license}}
...
\begin{equation}
 ...
 \begin{array}{ll}
v	 \infty & {|\mathbf{r}_i-\mathbf{r}_j|} \leq {a}\\
...
\paragraph{Project 1 a): Find analytic expressions for the local energy.}
\begin{equation}
