...
%% doconce format latex basicmanybody.do.txt --minted_latex_style=trac --latex_admon=paragraph --no_mako
%%
...
\section*{Many-body Hamiltonians, basic linear algebra and Second Quantization}
...
\exercisesection*{Exercise \thedoconceexercisecounter: Relation between basis functions}
...
\exercisesection*{Exercise \thedoconceexercisecounter: Matrix elements}
...
\exercisesection*{Exercise \thedoconceexercisecounter: Normal-ordered one-body operator}
...
\exercisesection*{Exercise \thedoconceexercisecounter: Normal-ordered two-body operator}
...
\exercisesection*{Exercise \thedoconceexercisecounter: Matrix elements using the Slater-Condon rule}
...
\exercisesection*{Exercise \thedoconceexercisecounter: Program to set up Slater determinants}
...
\exercisesection*{Exercise \thedoconceexercisecounter: Using sympy to compute matrix elements}
