...
\begin{block}{Note numerical derivatives }
\begin{minted}[fontsize=\fontsize{9pt}{9pt},linenos=false,mathescape,baselinestretch=1.0,fontfamily=tt,xleftmargin=2mm]{c++}
...
\begin{frame}[plain,fragile]
\frametitle{Efficient calculation of Slater determinants}
...
\begin{frame}[plain,fragile]
\frametitle{Matrix elements of Slater determinants}
...
\begin{frame}[plain,fragile]
\frametitle{The gradient and the Laplacian}
...
\begin{frame}[plain,fragile]
\frametitle{How to compute the derivates of the Slater determinant}
...
\begin{frame}[plain,fragile]
\frametitle{The Slater determinant}
...
\begin{frame}[plain,fragile]
\frametitle{Rewriting the Slater determinant}
...
\begin{frame}[plain,fragile]
\frametitle{Splitting the Slater determinant}
...
\begin{frame}[plain,fragile]
\frametitle{Spin up and spin down parts}
...
\begin{frame}[plain,fragile]
\frametitle{Counting the number of FLOPS}
...
\begin{frame}[plain,fragile]
\frametitle{Computation of ratios}
...
\begin{frame}[plain,fragile]
\frametitle{How to get the determinant}
...
\begin{frame}[plain,fragile]
\frametitle{LU decomposition and determinant}
...
\begin{frame}[plain,fragile]
\frametitle{Expectation value of the kinetic energy}
...
\begin{frame}[plain,fragile]
\frametitle{Second derivative of the Jastrow factor}
...
\begin{frame}[plain,fragile]
\frametitle{Gradient and Laplacian}
...
\begin{frame}[plain,fragile]
\frametitle{The gradient for the determinant}
...
\begin{frame}[plain,fragile]
\frametitle{Single-particle states}
...
\begin{frame}[plain,fragile]
\frametitle{Problems with neon states for VMC}
...
\begin{frame}[plain,fragile]
\frametitle{Examples of spherical harmonics}
...
\begin{frame}[plain,fragile]
\frametitle{Problems with spherical harmonics}
...
\begin{frame}[plain,fragile]
\frametitle{Real solid harmonics}
...
\begin{frame}[plain,fragile]
\frametitle{Relation between solid harmonics and spherical harmonics}
...
\begin{frame}[plain,fragile]
\frametitle{The lowest-order real solid harmonics}
