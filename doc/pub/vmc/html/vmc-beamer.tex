...
\title{Slides from FYS-KJM4411/9411 Variational Monte Carlo methods}
...
\begin{block}{The c++ code with a VMC Solver class, all in one file }
\begin{minted}[fontsize=\fontsize{9pt}{9pt},linenos=false,mathescape,baselinestretch=1.0,fontfamily=tt,xleftmargin=2mm]{c++}
\end{minted}
\end{block}
\end{frame}
...
\begin{block}{Exercises for first lab session }
