...
\title{Slides from FYS4411/9411 Definitions of the many-body problem}
...
\and
National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, MI 48824, USA\inst{2}}
% ----------------- end author(s) -------------------------
