...
\title{Slides from FYS-KJM4411/9411 Definitions of the many-body problem}

% ----------------- author(s) -------------------------

\author{Morten Hjorth-Jensen\inst{1}}
\institute{Department of Physics, University of Oslo, Oslo, Norway and National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, MI 48824, USA\inst{1}}
% ----------------- end author(s) -------------------------
...
\begin{frame}[plain,fragile]
\frametitle{Quantum Many-particle Methods}
